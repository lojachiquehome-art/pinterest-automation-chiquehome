...
const CAMPAIGN_PATH = path.join(ROOT, "data", "weekly_campaign_2026-09-07.csv");
const PREVIEW_DIR = path.join(ROOT, "public", "pinterest", "preview-2026-09-07");
...
const collectionSlug = {
  ...
  "Decoracao de parede": "decoracao-de-parede",
  ...
  "Presentes para casa nova": "presentes-para-casa-nova",
...
console.log(`Staged ${rows.length} pins for 2026-09-07 to 2026-09-13.`);
