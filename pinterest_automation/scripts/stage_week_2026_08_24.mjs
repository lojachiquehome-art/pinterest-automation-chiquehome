...
const CAMPAIGN_PATH = path.join(ROOT, "data", "weekly_campaign_2026-08-24.csv");
const PREVIEW_DIR = path.join(ROOT, "public", "pinterest", "preview-2026-08-24");
...
console.log(`Staged ${rows.length} pins for 2026-08-24 to 2026-08-30.`);
